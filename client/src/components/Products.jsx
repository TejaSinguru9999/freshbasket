...
function Products({ title, data }) {
    console.log(data[0])
    return (
        <div className='productsPageContainer h-[88vh] w-screen p-2 overflow-y-auto'>
            ...
            <div className='productsContainer p-2 pt-5'>
                {data.map((product, index) => {
                    return <div className='productContainer w-full h-[27.5rem] overflow-hidden rounded-md shadow-md' key={index}>
                        <div className='productImgContainer overflow-hidden w-full h-[70%]'>
